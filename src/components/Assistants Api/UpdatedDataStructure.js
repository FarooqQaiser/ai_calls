const dataStructure = {
  ...
  model: {
    ...
    tools: [
      {
        ...
        server: { timeoutSeconds: 20, url: "<string>", secret: "<string>" },
      },
    ],
    toolIds: ["<string>"],
    provider: "anyscale",
    model: "<string>",
    temperature: 1,
    knowledgeBase: { provider: "canonical", topK: 5.5, fileIds: ["<string>"] },
    maxTokens: 525,
  ...
  voice: {
    ...
    chunkPlan: {
      ...
      formatPlan: {
        ...
        replacements: [{ type: "exact", key: "<string>", value: "<string>" }],
      },
    },
  },
