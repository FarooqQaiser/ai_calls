...
import DeletePhoneNumber from "../../components/Phone Numbers/DeletePhoneNumber";
...
const PhoneNumbers = () => {
  ...
  const [deletePhoneNumberId, setDeletePhoneNumberId] = useState("");
  ...
  const handleDeletePhoneNumber = (phoneNumberId) => {
    ...
    setDeletePhoneNumberId(phoneNumberId);
  };
              ...
              {showPhoneNoDetail ? (
                <>
                  ...
                  {showDeletePhoneNumber && (
                    <>
                      <DeletePhoneNumber
                        setShowDeletePhoneNumber={setShowDeletePhoneNumber}
                        deletePhoneNumberId={deletePhoneNumberId}
                        userId={userId}
                        setShowPhoneNoDetail={setShowPhoneNoDetail}
                      />
                    </>
                  )}
                </>
