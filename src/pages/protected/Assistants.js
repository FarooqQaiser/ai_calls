...
const Assistants = () => {
  ...
  useEffect(() => {
    ...
    const fetchExampleAssistants = async () => {
      try {
        const response = await fetch(
          ASSISTANTS_API_URL,
          TEST_ASSISTANTS_API_OPTIONS
        ...
        result = await response.json();
        console.log("Test Example Assistant: ", result);
      } catch (err) {
        console.error(err);
      }
    };

    fetchExampleAssistants();
  }, []);
      ...
      {loading ? (
        <>
          <div className="w-full h-full flex justify-center items-center">
            <MoonLoader color={"#3F00E7"} size={60} speedMultiplier={0.7} />
          </div>
        </>
      ) : (
        <>
                    ...
                    >
                      <CCard>
                        <CCardBody className="bg-background/80">
                          ...
                          <p>
                            This section allows you to configure the model for
                            the assistant.
                          </p>
                                ...
                                {assistantTranscriberProvider ===
                                  ...
                                  <>
                                    <p className="text-xs">
                                      ...
                                      language to multi and use ElevenLabs Turbo
                                      2.5 in the Voice tab.
                                    </p>
                                  </>
                                )}
                              </div>
                              ...
                              <CFormSelect className="text-sm rounded-lg block w-full p-2.5 mb-2">
                                {assistantTranscriberProvider === "deepgram"
                                  ? transcriberModel[1].model.map(
                                      (model, index) => {
                                        if (
                                          assistantTranscriberModel === model
                                        ) {
                                          return (
                                            <>
                                              <option
                        ...
                        <CCardBody className="bg-background/80">
                          ...
                          <div className="rounded-xl p-3 bg-gray-200 dark:bg-[#191E24] shadow mt-3">
                            ...
                            <div className="mt-2">
                              ...
                              <p className="text-xs">
                                These are the punctuations that are considered
                                valid boundaries or delimiters. This helps
                                decides the chunks that are sent to the voice
                                provider for the voice generation as the LLM
                              ...
                              <div className="flex justify-start items-center">
                                ...
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-xs">
                                    ...
                                    into the Model output before inputting it
                                    into the Voice provider.
                                  </span>
                                </div>
                              </div>
                              <label className="flex justify-between items-center cursor-pointer">
                      ...
                      <CCard>
                        <CCardBody className="bg-background/80">
                          ...
                          >
                            ...
                            follow older syntax as per the OpenAI Spec. Check
                            our{" "}
                            <a href="/" className="font-semibold underline">
                              functions guide
                            </a>{" "}
                    ...
                    >
                            ...
                            <div className=" flex justify-between items-center py-3">
                              <div className="flex justify-start items-center">
                                ...
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-xs">
                                    When this is enabled, no logs, recordings,
                                    or transcriptions will be stored.
                                  </span>
                                </div>
                              </div>
                              <label className="flex justify-between items-center cursor-pointer">
                            ...
                            >
                              <div className="flex justify-start items-center">
                                ...
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-xs">
                                    Enable or disable video recording during a
                                    web call. This will record the video of your
                                    user.
                                  </span>
                                </div>
                              </div>
                          ...
                          <div className="rounded-xl p-3 border bg-gray-200 dark:bg-[#191E24] border-[#1A1C1F] dark:border-bg-gray-300 shadow mt-3">
                            <div className=" flex justify-between items-center py-3">
                              ...
                              <div className="flex justify-end items-center">
                                ...
                                />
                                <div className="flex text-lg ml-4 text-primary rounded-xl bg-gray-200 dark:bg-[#14171A] shadow-sm shadow-black/10 transition-all duration-150 ease-in-out justify-center items-center min-w-[60px] min-h-[40px]">
                                  {silenceTimeout}
                                </div>
                              </div>
                            </div>
                              ...
                              <div className="flex justify-start items-center">
                                ...
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-xs">
                                    ...
                                    punctuation before sending a request to the
                                    LLM.
                                  </span>
                                </div>
                              </div>
                            ...
                            <div className=" flex justify-between items-center py-3">
                              <div className="flex justify-start items-center">
                                ...
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-xs">
                                    The number of words the user must say before
                                    the assistant considers being interrupted.
                                  </span>
                                </div>
                              </div>
                              <div className="flex justify-end items-center">
                            ...
                            <div className=" flex justify-between items-center py-3">
                              <div className="flex justify-start items-center">
                                ...
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-xs">
                                    The maximum number of seconds a call will
                                    last.
                                  </span>
                                </div>
                              </div>
                      ...
                      <CCard className="mt-5">
                        <CCardBody className="bg-background/80">
                          ...
                          <p>
                            Message configuration for messages that are sent to
                          ...
                          <div className="rounded-xl p-3 border bg-gray-200 dark:bg-[#191E24] border-[#1A1C1F] dark:border-bg-gray-300 shadow mt-3">
                            <div>
                              ...
                              <div className="text-xs mb-1">
                                ...
                                messages via HTTP POST Requests. This is used
                                for retrieving context, function calling, and
                                end-of-call reports.
                              </div>
                              <CFormInput
                                className="text-sm rounded-lg block w-full p-2.5 my-2"
                            ...
                            <div className="my-2">
                              ...
                              <div className="text-xs mb-1">
                                This is the message that the assistant will say
                                if the call is forwarded to voicemail.
                              </div>
                              <CFormInput
                            ...
                            <div className="my-2">
                              ...
                              <div className="text-xs mb-1">
                                Messages that the assistant will speak when the
                    ...
                    >
                      <CCard>
                        <CCardBody className="bg-background/80">
                          ...
                          <p>
                            ...
                            call. The output is stored in call.analysis.summary.
                            You can also find the summary in the Call Logs Page.
                          </p>
                          <div className="rounded-xl p-3 bg-gray-200 dark:bg-[#191E24] border-[#1A1C1F] dark:border-bg-gray-300 shadow border mt-3">
                            <div className="flex justify-start items-center">
                      ...
                      <CCard className="mt-5">
                        <CCardBody className="bg-background/80">
                          ...
                          <p>
                            Evaluate if your call was successful. You can use
                            Rubric standalone or in combination with Success
                            Evaluation Prompt. If both are provided, they are
                      ...
                      <CCard className="mt-5">
                        <CCardBody className="bg-background/80">
                          ...
                          <p>
                            Extract structured data from call conversation. You
                            can use Data Schema standalone or in combination
                            with Structured Data Prompt. If both are provided,
                            they are concatenated into appropriate instructions.
                          </p>
                          <div className="rounded-xl p-3 bg-gray-200 dark:bg-[#191E24] border-[#1A1C1F] dark:border-bg-gray-300 shadow border mt-3">
                            <div className="flex justify-start items-center">
                              <div className="w-full">
                                ...
                                <div className="mt-3">
                                  ...
                                  <div className="text-xs mb-1">
                                    ...
                                    extracted. Add various properties you want
